		...
		<div class="col-md-6 col-sm-6">
			<div class="bs-component">
				<div class="well download">
					...
					<a href="/data/CodeIgniter-3.1.3-userguide.zip" class="btn btn-warning btn-block"><span class="glyphicon glyphicon-save"></span> Download the User Guide</a>
					<a href="/data/CodeIgniter User Guide 3.1.3.epub" class="btn btn-warning btn-block"><span class="glyphicon glyphicon-save"></span> Download the epub format U.G.</a>
