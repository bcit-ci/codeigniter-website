		...
		<div class="col-md-6 col-sm-6">
			<div class="bs-component">
				<div class="well download">
					...
					CodeIgniter 3.1.10 is the current version of the framework.<br><br>
					...
					<a href="https://github.com/bcit-ci/CodeIgniter/archive/3.1.10.zip" class="btn btn-primary btn-block"><span class="glyphicon glyphicon-save"></span> Download CodeIgniter 3</a>
					<a href="https://github.com/bcit-ci/codeigniter3-translations/releases/latest" class="btn btn-primary btn-block"><span class="glyphicon glyphicon-save"></span> Download System Message Translations</a>
				</div>
			</div>
		</div>
		<div class="col-md-6 col-sm-6">
