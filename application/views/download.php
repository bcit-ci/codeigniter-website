		...
		<div class="col-md-6 col-sm-6">
			<div class="bs-component">
				<div class="well download">
					...
					CodeIgniter 3.1.7 is the current version of the framework.<br><br>
					...
					<a href="https://github.com/bcit-ci/CodeIgniter/archive/3.1.7.zip" class="btn btn-primary btn-block"><span class="glyphicon glyphicon-save"></span> Download CodeIgniter 3</a>
